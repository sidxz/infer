...
<body>
    ...
    <!-- Header -->
    <header id="top" class="header white-text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h4><strong>Siddhant Rath</strong>
                    </h4>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:name@example.com">sid@tamu.edu</a>
                        </li>
                    </ul>
                    <br>
                    <ul class="list-inline">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-git fa-fw fa-3x"></i></a>
                        </li>
                </div>
            </div>
        </div>
